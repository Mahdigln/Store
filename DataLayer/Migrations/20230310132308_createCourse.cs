            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EpisodeId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CourseId = table.Column<int>(type: "int", nullable: false),
                    EpisodeTitle = table.Column<string>(type: "nvarchar(460)", maxLength: 460, nullable: false),
                    EpisodeTime = table.Column<TimeSpan>(type: "time", maxLength: 200, nullable: false),
